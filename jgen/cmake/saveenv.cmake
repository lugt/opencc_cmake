...
add_library(wgen_func ${WGEN_SRC})
target_compile_options(wgen_func PUBLIC ${TEMP_C_OPT} ${HOST_COMPILER_OPT} ${LOCAL_COMPLER_OPT} ${HOST_C_OPT} ${LOCAL_C_OPT})
target_include_directories(wgen_func PUBLIC ${LOCAL_INC_DIR} ${HOST_INC_DIR})
target_compile_definitions(wgen_func PUBLIC ${HOST_DEF} ${LOCAL_DEF})
target_link_libraries(wgen_func comutils spin cmplrs iberty wgen_util_o)
...
target_link_libraries(jwtest comutils jgen_util_o wgen_func comutils spin cmplrs iberty)
