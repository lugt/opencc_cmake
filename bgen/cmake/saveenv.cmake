...
add_library(bgen SHARED ${BGEN_SRCS})
...
add_executable(bgtest ${BGTEST_SRCS})
target_compile_options(bgtest PUBLIC ${TEMP_C_OPT} ${HOST_COMPILER_OPT} ${LOCAL_COMPLER_OPT} ${HOST_C_OPT} ${LOCAL_C_OPT})
target_include_directories(bgtest PUBLIC ${LOCAL_INC_DIR} ${HOST_INC_DIR})
target_compile_definitions(bgtest PUBLIC ${HOST_DEF} ${LOCAL_DEF})
target_link_libraries(bgtest comutils jgen_util_o common_gen_func comutils spin cmplrs iberty bgen)
